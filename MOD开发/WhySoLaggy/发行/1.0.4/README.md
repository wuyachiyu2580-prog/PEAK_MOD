...
1.0.4 focuses on **quiet-by-default**, **structured data** and **targeted diagnostics**: profilers are off until you need them, while the network and RPC monitors preserve bounded, recent evidence for post-session analysis.
